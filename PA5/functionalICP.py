...
@click.option("-n", "--name", default="PA4-F-Debug", help="Which experiment to run.")
def main(
    ...
    #build tree
    tree = covariancetree.CovTreeNode(things,len(things))
    ...
    while (convergence == False):
        ...
        for k in track(range(sample_readings.N_samps), "Computing closest points..."):
            ...
            #FOR COVTREE
            c[k] = tree.findClosestPoint(s[k], c[k], bound)
